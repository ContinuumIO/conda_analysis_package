...
def get_version(meta):
    s = '%(creator)s:%(analysispackage_name)s' % meta
    h = hashlib.new('sha1')
...
if __name__ == '__main__':
    try:
        ...
        path = 'analysispackage-90809033a16372615e953f6961a6a272a4b35a1a.tar.bz2'
    clone_analysispackage(path,
